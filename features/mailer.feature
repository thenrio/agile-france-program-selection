...
Feature: In order to save customer time
  ...
  Scenario: 
    Given mail uses "development" environment
      ...
      And "thierry" has two scheduled sessions
    When speaker thierry is mailed with template "ask_speaker_for_feedback.html.haml" and subject "Comment s'est passé la conférence Agile France ?"
  ...
  Scenario:
    ...
    Then thierry should receive a mail